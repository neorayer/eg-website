...
<table id="player-eglevel-list-box" width="100%" cellpadding="0" cellspacing="0">
	...
	<tbody>
	  <c:forEach var="userpoint" items="${userpoints}">
	  	<tr>
	  		<td><c:out value="${userpoint.gameZone.name}"/></td>
	  		<td><c:out value="${userpoint.win}"/></td>
	  		<td><c:out value="${userpoint.lose}"/></td>
	  		<td><c:out value='${userpoint.rate}'/></td>
	  		<td><c:out value="${userpoint.point}"/></td>
	  		<td><c:out value="${userpoint.rank}"/></td>
	  	</tr>
	  </c:forEach>
	</tbody>
</table>
