...
<form id="page-membersendmsg-form" action="../team/msg.member_send.json.do" method="post">
	<input type="hidden" name="teamid" value="<c:out value='${team.id }'/>" />
	<input type="hidden" name="username" value="<c:out value='${user.username }'/>" />
	<DIV id="SOR_EXCEPTION" style="color:red"><c:out value="${REASON}" ></c:out></DIV>
	<h3 id="member-send-msg-head-box">写新消息</h3>
...
$(document).ready(function(){
	$("#page-membersendmsg-form").validate({
